...
int main() {
    ...
    constexpr std::uint64_t EXPECTED_CLASS_SKIP = 950949589ULL;
    constexpr std::uint64_t EXPECTED_TRACKED = 122792235ULL;
...
#pragma omp critical
    ...
    const u128 new_floor = 4 * (p44 + p30) + 2;
    ...
    std::cout << "old verified floor: " << s128(old_floor) << "\n";
    std::cout << "new verified floor: " << s128(new_floor) << "\n";
    std::cout << "verified-floor increment: " << s128(new_floor-old_floor) << "\n";
}
