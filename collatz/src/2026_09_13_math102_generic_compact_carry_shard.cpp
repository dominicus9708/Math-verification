// Generic compact 2-adic carry verifier for one-paid phase-danger tables.
// Usage: verifier PREFIX TARGET ZMIN [START [STOP]]
// Example: verifier t11 11 33 0 254
